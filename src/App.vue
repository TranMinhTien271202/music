<template>
      ...
      <div class="header__actions">
        ...
        <div class="header__action header__action--note">
          ...
          <div class="header__drop">
            <a href="#" class="header__all">Xem tất cả</a>
        ...
        <div class="header__action header__action--cart">
          <span>3</span>
          <a class="header__action-btn" href="cart.html"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
              <path
                d="M8.5,19A1.5,1.5,0,1,0,10,20.5,1.5,1.5,0,0,0,8.5,19ZM19,16H7a1,1,0,0,1,0-2h8.49121A3.0132,3.0132,0,0,0,18.376,11.82422L19.96143,6.2749A1.00009,1.00009,0,0,0,19,5H6.73907A3.00666,3.00666,0,0,0,3.92139,3H3A1,1,0,0,0,3,5h.92139a1.00459,1.00459,0,0,1,.96142.7251l.15552.54474.00024.00506L6.6792,12.01709A3.00006,3.00006,0,0,0,7,18H19a1,1,0,0,0,0-2ZM17.67432,7l-1.2212,4.27441A1.00458,1.00458,0,0,1,15.49121,12H8.75439l-.25494-.89221L7.32642,7ZM16.5,19A1.5,1.5,0,1,0,18,20.5,1.5,1.5,0,0,0,16.5,19Z" />
            </svg></a>

          <div class="header__drop">
            <a href="cart.html" class="header__all">Đi tới giỏ hàng</a>
  ...
  <div class="sidebar">
    ...
    <ul class="sidebar__nav">
      <li class="sidebar__nav-item">
        <router-link to="/" class="sidebar__nav-link sidebar__nav-link--active"><svg xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24">
            <path
      ...
      <li class="sidebar__nav-item">
        <router-link to="/about" class="sidebar__nav-link sidebar__nav-link--active"><svg
            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <path
              d="M12.3,12.22A4.92,4.92,0,0,0,14,8.5a5,5,0,0,0-10,0,4.92,4.92,0,0,0,1.7,3.72A8,8,0,0,0,1,19.5a1,1,0,0,0,2,0,6,6,0,0,1,12,0,1,1,0,0,0,2,0A8,8,0,0,0,12.3,12.22ZM9,11.5a3,3,0,1,1,3-3A3,3,0,0,1,9,11.5Zm9.74.32A5,5,0,0,0,15,3.5a1,1,0,0,0,0,2,3,3,0,0,1,3,3,3,3,0,0,1-1.5,2.59,1,1,0,0,0-.5.84,1,1,0,0,0,.45.86l.39.26.13.07a7,7,0,0,1,4,6.38,1,1,0,0,0,2,0A9,9,0,0,0,18.74,11.82Z" />
          </svg>
          <span>Nghệ sĩ</span></router-link>
      </li>
      <li class="sidebar__nav-item">
        <router-link to="/about" class="sidebar__nav-link sidebar__nav-link--active">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <path
  ...
  <div class="player">
    ...
    <div class="player__content">
      <span class="player__track"><b class="player__title">Em của ngày hôm qua</b> –
        <span class="player__artist">Sơn Tùng MTP</span></span>
      <audio src="/dist/music/em-cua-ngay-hom-qua.mp3"
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-12 col-sm-8 col-md-6 col-lg-6 col-xl-4 order-4 order-md-1 order-lg-4 order-xl-1">
          ...
          <p class="footer__tagline">Music house, Tận hưởng âm nhạc ở mọi nơi.</p>
        ...
        <div class="col-6 col-md-4 col-lg-3 col-xl-2 order-1 order-md-2 order-lg-1 order-xl-2 offset-md-2 offset-lg-0">
          <h6 class="footer__title">Về Music House</h6>
          <div class="footer__nav">
            <a href="about.html">Về chúng tôi</a>
            <a href="profile.html">Hồ sơ của chúng tôi</a>
            <a href="pricing.html">Giá dịch vụ</a>
            <a href="contacts.html">Liên hệ</a>
          </div>
        </div>

        <div class="col-6 col-md-8 col-lg-6 col-xl-4 order-3 order-lg-2 order-md-3 order-xl-3">
          <div class="row">
            <div class="col-12">
              <h6 class="footer__title">Tính năng</h6>
            </div>

            <div class="col-6">
              <div class="footer__nav">
                <a href="artists.html">Nghệ sĩ</a>
                <a href="releases.html">Âm nhạc</a>
                <a href="events.html">Sự kiện</a>
                <a href="podcasts.html">Trực tiếp</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-6 col-md-4 col-lg-3 col-xl-2 order-2 order-lg-3 order-md-4 order-xl-4">
          <h6 class="footer__title">Hỗ trơ</h6>
          <div class="footer__nav">
            <a href="privacy.html">Tài khoản & Thanh toán</a>
            <a href="privacy.html">Gói & Giá dịch vụ</a>
            <a href="privacy.html">Thiết bị hỗ trợ</a>
